function mascara(o, f) {
  //Esta linha define uma função chamada mascara com dois parâmetros: o e f. o representa um elemento de entrada de texto (geralmente um campo de número de telefone), e f é uma função de formatação que será aplicada a esse elemento.
...
window.onload = function () {
  //faz com que a formatação aconteça quando a página web terminar de carregar e você comece a digitar no campo de telefone.
